...
def yy_validation():
    m = Model02()
    # m.restore(MODEL_BASE + "SNAP3/m2.cpt-127-0.6673999997973442")
    m.restore(MODEL_BASE + "SNAP3/m3.cpt-13400-0.5315999990701674")
    inp = Model02Input(MODEL_BASE + 'test.csv')
