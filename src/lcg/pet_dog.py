...
def get_breed_list(page_no=1, page_size=10, filter_str=None):
    ...
    post_data = {"pageNo": page_no, "pageSize": page_size, "querySortType": "CREATETIME_DESC",
                 "petIds": ["1898052082261091213", "2015373030965946228", "2006547388568224593",
                            "2015375951543759107",
                            "1872732597214615937", "2015385228673277532", "2000517941679259200",
                            "2015380899346175726",
                 ...
                 "appId": 1, "tpl": "", "type": 1, "requestId": 1522913482922, "timeStamp": None,
                 "nounce": None,
                 "token": None}
...
def market_list(page_no=1, page_size=10, filter_str=None):
    ...
    jsr = json.loads(result)
    lr = []
    for pet in jsr['data']['petsOnSale']:
        lr.append(pet['petId'])
    return lr, jsr['data']['hasData']
...
class MarketFilter(object):
    ...
    def __gen_type__(self):
        ...
        self._type = []
        dim_1 = ['0', '1', '2', '3', '4', '5']
        dim_3 = ['0-1', '1440-1441', '2880-2881', '5760-5761', '8640-8641', '11520-11521',
                 '14400-14401', '17280-17281']
        dim_5 = ['0-1000', '1000-2000-1441', '2000-3000-2881', '3000-5000-5761', '5000-10000-8641',
                 '10000-x']
        dim_6 = ['0', '1']
...
class BreedFilter(object):
    ...
    def __gen_breed_type__(self):
        ...
        dim_3 = ['0-1', '1440-1441', '2880-2881', '5760-5761', '8640-8641', '11520-11521',
                 '14400-14401', '17280-17281']
        dim_4 = ['0-1000', '1000-2000-1441', '2000-3000-2881', '3000-5000-5761', '5000-10000-8641',
                 '10000-x']
