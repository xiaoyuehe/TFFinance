...
class SimpleLstmRnn(object):
    ...
    def train(self,inputs,outputs):
        with tf.Session() as sess:
            ...
            _, loss_ = sess.run([self.train_op, self.loss], feed_dict={self.input_holder:inputs, self.output_holder:outputs})
            return loss_
...
rnn_config.batch_size = 60
rnn_config.num_steps = 20
rnn_config.input_size = 2
rnn_config.output_size = 1
rnn_config.lr = 0.005
rnn_config.layer_nums = [100,200,100]
